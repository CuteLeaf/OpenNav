...
- **🖱️ 右键菜单交互**: 链接卡片右键可弹出快捷菜单，支持添加、编辑、删除、复制、推荐链接等操作
- **⚡ 快速添加网站**: 首页直接粘贴链接可弹出快速添加链接对话框，无需进入后台
- **⚡ 支持二级分类**：内容区域支持二级分类菜单，更精细整理各类网站。
- **🤏 拖拽排序功能**:
  - 支持网站卡片拖拽排序
  - 支持侧边栏分类拖拽排序
- **🔄 重复链接验证功能**:
...
- **链接管理**：完整的增删改查功能，批量删除，批量修改公开，私有状态，还有更方便的批量更换分类功能
...
2.  **获取代码**:
    ...
    ```bash
    git clone https://github.com/CuteLeaf/OpenNav.git
    cd booknav
